package pe.joedayz.pedidoapp.base;
...
import static pe.joedayz.pedidoapp.util.LogUtil.logD;
import static pe.joedayz.pedidoapp.util.LogUtil.makeLogTag;
...
/*            case R.id.nav_pedidos:
                startActivity(new Intent(this, NotasPedidoListActivity.class));
                finish();
                break;
            case R.id.nav_tipo_cambio:
    ...
    public void logout(){
        SharedPreferences sharedPrefs =getSharedPreferences(SHARED_PREFERENCES_NAME,MODE_PRIVATE);
