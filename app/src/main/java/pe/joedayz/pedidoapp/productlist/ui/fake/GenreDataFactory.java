...
import pe.joedayz.pedidoapp.productlist.ui.fake.multicheck.MultiCheckGenre;
...
public class GenreDataFactory {
  ...
  public static List<SingleCheckGenre> makeSingleCheckGenres() {
    ...
    ArrayList<SingleCheckGenre> results = new ArrayList<>();
    results.add(makeSingleCheckRockGenre());
    results.add(makeSingleCheckJazzGenre());
    results.add(makeSingleCheckClassicGenre());
    results.add(makeSingleCheckSalsaGenre());
    results.add(makeSingleCheckBluegrassGenre());

    return results;
  }


  public static List<SingleCheckGenre> makeSingleCheckGenres2() {
